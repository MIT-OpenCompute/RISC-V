...
### scala.reflect.internal.FatalError: no context found for source-file://<WORKSPACE>/src/main/scala/RISCV/Registers.scala,line-1,offset=34
...
text:
```scala
// See README.md for license detai@@ls.
