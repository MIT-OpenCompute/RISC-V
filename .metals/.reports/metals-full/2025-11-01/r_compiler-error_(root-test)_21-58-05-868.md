...
### scala.reflect.internal.FatalError: no context found for source-file://<WORKSPACE>/src/test/scala/RISCV/MainSpec.scala,line-1,offset=32
...
text:
```scala
// See README.md for license det@@ails.
