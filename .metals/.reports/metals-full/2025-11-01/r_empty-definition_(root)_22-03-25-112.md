error id: file://<WORKSPACE>/src/main/scala/RISCV/Main.scala:local1
file://<WORKSPACE>/src/main/scala/RISCV/Main.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/io/debug_out.
	 -chisel3/io/debug_out#
	 -chisel3/io/debug_out().
	 -chisel3/util/io/debug_out.
	 -chisel3/util/io/debug_out#
	 -chisel3/util/io/debug_out().
	 -scala/math/io/debug_out.
	 -scala/math/io/debug_out#
	 -scala/math/io/debug_out().
	 -io/debug_out.
	 -io/debug_out#
	 -io/debug_out().
	 -scala/Predef.io.debug_out.
	 -scala/Predef.io.debug_out#
	 -scala/Predef.io.debug_out().
offset: 1343
...
class Main() extends Module {
    val io = IO(new Bundle {
        ...
        val debugRegFileA_out = Output(UInt(32.W))
    })
