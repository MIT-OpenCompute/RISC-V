error id: file://<WORKSPACE>/src/test/scala/RISCV/MainSpec.scala:
file://<WORKSPACE>/src/test/scala/RISCV/MainSpec.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/dut/io/instruction/poke.
	 -chisel3/dut/io/instruction/poke#
	 -chisel3/dut/io/instruction/poke().
	 -chisel3/experimental/BundleLiterals.dut.io.instruction.poke.
	 -chisel3/experimental/BundleLiterals.dut.io.instruction.poke#
	 -chisel3/experimental/BundleLiterals.dut.io.instruction.poke().
	 -dut/io/instruction/poke.
	 -dut/io/instruction/poke#
	 -dut/io/instruction/poke().
	 -scala/Predef.dut.io.instruction.poke.
	 -scala/Predef.dut.io.instruction.poke#
	 -scala/Predef.dut.io.instruction.poke().
offset: 2756
...
class MainSpec extends AnyFreeSpec with Matchers with ChiselSim {
  ...
  "main should pass tests" in {
    simulate(new Main()) { dut =>
        ...
        dut.io.instruction.p@@oke(lui_instruction) // Load the immediate into register x1



        // TEST SLTI instruction: slti x3, x2, 5
        // x1 = b00000000000000000001000000000000 (4096 in decimal)
        // Since 4096 < 5 is false, x3 should be set to 0
        ...
        dut.io.RegFileA_out.expect(0.U) // Expecting 0 since 4096 < 5 is false
        dut.io.RegFileB_out.expect(0.U)
    }
  }
}
