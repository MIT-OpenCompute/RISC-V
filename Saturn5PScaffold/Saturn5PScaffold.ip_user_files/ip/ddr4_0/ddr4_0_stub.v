...
// Date        : Tue Sep  8 10:14:08 2026
// Host        : arya running 64-bit EndeavourOS Linux
// Command     : write_verilog -force -mode synth_stub
//               /home/arya/Documents/Github/Saturn5PScaffold/Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ddr4_0_stub.v
// Design      : ddr4_0
...
(* CORE_GENERATION_INFO = "DDR4_SDRAM, DDR4_SDRAM,{x_ipProduct=Vivado 2017.2.0,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=DDR4_SDRAM,x_ipVersion=2.2, Controller_Type = DDR4_SDRAM, Time_Period = 750, Input_Clock_Period = 10000, Memory_Type = Components, Memory_Part = MT40A512M16TB-062E, Ecc = false, Cas_Latency = 19, Cas_Write_Latency = 14, DQ_Width = 16, Chip_Select = true, Data_Mask = DM_NO_DBI, MEM_ADDR_ORDER = ROW_COLUMN_BANK,  Is_AXI_Enabled = true , Slot_cofiguration =  Single , Clamshell_cofiguration =  false ,IS_FASTER_SPEED_RAM = No, Is_custom_part = false, Memory_Voltage = 1.2V, Phy_Only = Complete_Memory_Controller, Debug_Port = Disable, Burst_Length = 8, System_Clock = Differential, AXI_Selection = true, AXI_Data_Width = 128,  AXI_ArbitrationScheme = RD_PRI_REG, AXI_Narrow_Burst = false, Simulation_Mode = BFM, Debug_Mode = Disable, Example_TG = SIMPLE_TG, Self_Refresh = false, Save_Restore = false, Enable_LVAUX = false,MicroBlaze_ECC = false,  Specify_MandD = false, CLKBOUT_MULT = 10, DIVCLK_DIVIDE = 1, CLKOUT0_DIVIDE = 3}" *) (* X_CORE_INFO = "ddr4_v2_2_28,Vivado 2025.2" *) (* dont_touch = "true" *) 
module ddr4_0(sys_rst, c0_sys_clk_p, c0_sys_clk_n, 
  ...
  addn_ui_clkout1, addn_ui_clkout2, addn_ui_clkout3, dbg_clk, c0_ddr4_aresetn, 
...
/* synthesis syn_force_seq_prim="dbg_clk" */;
  ...
  output addn_ui_clkout2 /* synthesis syn_isclock = 1 */;
  output addn_ui_clkout3 /* synthesis syn_isclock = 1 */;
