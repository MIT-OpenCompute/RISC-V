...
design_libs=(xpm microblaze_v11_0_16 xil_defaultlib proc_sys_reset_v5_0_17 lmb_v10_v3_0_16 lmb_bram_if_cntlr_v4_0_27 blk_mem_gen_v8_4_12 iomodule_v3_1_13)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ip_1/rtl/map" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/ip_top" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/cal" +incdir+"../../../../../../../Xilinx2/2025.2/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ip_1/rtl/map" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/ip_top" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/cal" +incdir+"../../../../../../../Xilinx2/2025.2/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ip_1/rtl/map" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/ip_top" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/cal" +incdir+"../../../../../../../Xilinx2/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ip_1/rtl/map" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/ip_top" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/cal" +incdir+"../../../../../../../Xilinx2/2025.2/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/arya/Documents/Github/Saturn5PScaffold/Saturn5PScaffold.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ddr4_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ddr4_0_simv.daidir vcs_lib c.obj)
