...
#
# Script generated by Vivado on Tue Sep 08 10:11:52 EDT 2026
...
#
# Usage        : ddr4_0.sh
#                ddr4_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ddr4_0.sh [-rerun]
#                ddr4_0.sh [-reset_run]
#                ddr4_0.sh [-clean]
#                ddr4_0.sh [-reset_log]
...
#                script (type 'ddr4_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname microblaze_v11_0_16 -libname xil_defaultlib -libname proc_sys_reset_v5_0_17 -libname lmb_v10_v3_0_16 -libname lmb_bram_if_cntlr_v4_0_27 -libname blk_mem_gen_v8_4_12 -libname iomodule_v3_1_13 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm microblaze_v11_0_16 xil_defaultlib proc_sys_reset_v5_0_17 lmb_v10_v3_0_16 lmb_bram_if_cntlr_v4_0_27 blk_mem_gen_v8_4_12 iomodule_v3_1_13)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "ddr4_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ddr4_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ip_1/rtl/map" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/ip_top" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/cal" +incdir+"../../../../../../../Xilinx2/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ip_1/rtl/map" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/ip_top" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/cal" +incdir+"../../../../../../../Xilinx2/2025.2/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ip_1/rtl/map" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/ip_top" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/cal" +incdir+"../../../../../../../Xilinx2/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/ip_1/rtl/map" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/ip_top" +incdir+"../../../../Saturn5PScaffold.gen/sources_1/ip/ddr4_0/rtl/cal" +incdir+"../../../../../../../Xilinx2/2025.2/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ddr4_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ddr4_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/arya/Documents/Github/Saturn5PScaffold/Saturn5PScaffold.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ddr4_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ddr4_0.sh [-step]\n\
Usage: ddr4_0.sh [-lib_map_path]\n\
Usage: ddr4_0.sh [-rerun]\n\
Usage: ddr4_0.sh [-reset_run]\n\
Usage: ddr4_0.sh [-clean]\n\
Usage: ddr4_0.sh [-reset_log]\n\
Usage: ddr4_0.sh [-keep_index]\n\
