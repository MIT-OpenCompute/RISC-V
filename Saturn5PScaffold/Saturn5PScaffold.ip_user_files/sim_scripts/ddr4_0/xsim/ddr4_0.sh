...
export RDI_DATADIR="/home/arya/Xilinx2/2025.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L microblaze_v11_0_16 -L proc_sys_reset_v5_0_17 -L lmb_v10_v3_0_16 -L lmb_bram_if_cntlr_v4_0_27 -L blk_mem_gen_v8_4_12 -L iomodule_v3_1_13 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr4_0 xil_defaultlib.ddr4_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/arya/Xilinx2/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ddr4_0.wdb xsim.dir libdpi.so)
